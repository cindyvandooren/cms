                      ...
                      function drawChart() {
                        var data = google.visualization.arrayToDataTable([
                          ['Date', 'Count'],
                            ...
                            <?php
                                $element_text = ['All Posts', 'Published Posts', 'Draft Posts', 'Comments', 'Unapproved Comments', 'Users', 'Subscribed Users', 'Categories'];
                                $element_count = [$post_counts, $post_published_count, $post_draft_count, $comment_counts, $comment_unapproved_count, $user_counts, $user_subscriber_count, $categories_counts];
